...
SECRET_KEY = 'django-insecure-2r&v*ny_^*o6s9xv^4rgmq0i0um+_9cx93%j@-sb8a7fazzl*9'
...
EMAIL_HOST = 'smtp.gmail.com' # Or your email host 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'youremail@gmail.com'  # Your email
EMAIL_HOST_PASSWORD = 'password'  # Your email app password